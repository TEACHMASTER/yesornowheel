        ...
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-2 lg:col-span-3">
              {/* Logo */}
              <Link className="inline-block" href={ currentLocale === defaultLocale ? '/' : `/${currentLocale}`} title="yes or no wheel">
                <Logo />
              </Link>
            </div>
            ...
            <div className="md:col-span-10 lg:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href={ (currentLocale === defaultLocale ? '/' : `/${currentLocale}/`)+'random-number-generator-wheel'} title="random number generator wheel">
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h4 className="font-medium uppercase mb-2">Company</h4>
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href={currentLocale === defaultLocale ? '/about' : `/${currentLocale}/about`} title="yes or no wheel about">
                      About us
                    </a>
                  </li>
                </ul>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-sm md:order-1 text-gray-700 mb-2 md:mb-0">
              <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href={ currentLocale === defaultLocale ? '/privacy' : `/${currentLocale}/privacy`} title="yes or no wheel privacy">
                Privacy Policy
              </a>
            </div>

            {/* Copyrights note */}
            <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; yes-or-no.org. All rights reserved.</div>
          </div>
        </div>
      </div>
    </footer>
